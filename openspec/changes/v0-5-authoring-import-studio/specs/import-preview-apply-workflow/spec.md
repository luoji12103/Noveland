...
Unify import run lifecycle, proposal review, selective apply, rollback hints, and audit records. This capability belongs to v0.5 Authoring & Import Studio and is planned future work until implemented and archived.

## ADDED Requirements

### Requirement: Import Preview/Apply Workflow provides the planned workflow
The system SHALL provide Import Preview/Apply Workflow capability for Import run lifecycle, Proposal review, Selective apply, Audit trail while preserving worldline, ACL, provider, media, secret, and invocation boundaries.
