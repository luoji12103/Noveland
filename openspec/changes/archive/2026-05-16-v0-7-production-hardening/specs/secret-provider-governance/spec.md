...
Support provider disable, auth_ref rotation, provider audit, and provider-scoped permissions without storing or exposing resolved provider secrets. This capability belongs to v0.7 Production Hardening and is planned future work until implemented and archived.
