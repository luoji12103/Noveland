# Dialogue Style & OOC Review

## Capability

Check character speech style, relationship consistency, and out-of-character risk. This capability belongs to v0.6 Runtime Narrative Quality and is planned future work until implemented and archived.

## ADDED Requirements

### Requirement: Dialogue Style & OOC Review provides the planned workflow
