...
- Full ComfyUI workflow editor in v0.9.
- ComfyUI custom node installation or management from Noveland.
- LoRA training.
- Model downloading in v0.9 unless a later spec explicitly adds it.
- Provider, media, invocation, or secret boundary bypass.
- Exposing local model paths or storage paths to reader/player/member APIs.
