# Provider Worktree Integration Test Harness
...
- Default CI or local quota consumption.
- New secret storage backend.
- Provider execution outside `ProviderExecutionService`.
