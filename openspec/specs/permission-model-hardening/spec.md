# Permission Model Hardening Specification

## Purpose

This spec captures the current v0.7 permission model hardening capability on `main`. It covers explicit route permission matrix expectations and regression tests for platform-admin, world-admin, world-member, reader, and player actors.
## Requirements
