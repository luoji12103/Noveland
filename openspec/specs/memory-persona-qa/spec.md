# Memory & Persona QA Specification

## Purpose
This spec captures the current v1.0 memory and persona QA diagnostics on `main`. It covers admin-scoped drift and contamination checks, worldline-aware safe evidence references, proposal-only repair suggestions, and reuse of the existing narrative quality boundary.
