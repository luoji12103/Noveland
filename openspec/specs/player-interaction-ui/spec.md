# Player Interaction UI Specification

## Purpose

This spec captures the current v0.8 player interaction surface on `main`. It covers player choices, interventions, journal entries, notifications, and safe feedback display using existing player records and worldline-aware authorization.
