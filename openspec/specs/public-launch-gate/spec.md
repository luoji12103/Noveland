# Public Launch Gate Specification

## Purpose

This spec captures the current v0.8 public launch readiness gate on `main`. It covers aggregation of v0.7 internal production readiness with public-surface evidence, explicit signoff requirements, admin-safe reporting, and no automatic launch behavior.
