# Narrative Quality Dashboard/API Specification

## Purpose

This spec captures the current v0.6 API-first narrative quality diagnostics boundary on `main`. It covers dashboard-ready admin DTOs, quality summaries, safe diagnostic evidence, and the dedicated `narrative_quality` package/router without requiring a Web dashboard.
## Requirements
