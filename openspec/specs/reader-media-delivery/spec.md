# Reader Media Delivery Specification

## Purpose

This spec captures the current v0.8 reader-safe media descriptor and application-mediated delivery contract on `main`. It covers authenticated reader/member/player/admin media access, visibility-policy intersection, storage-backed download, and no-leak response boundaries.
