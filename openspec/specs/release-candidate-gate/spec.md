# release-candidate-gate Specification

## Purpose
This spec captures the current v1.1 release-candidate readiness gate on `main`. It covers admin-only aggregation of operational, backup/restore, stress, safety/moderation, import/export, provider reliability, user-facing polish, prior readiness, manual checklist, and no-leak evidence while distinguishing release-candidate readiness from public launch readiness.
## Requirements
