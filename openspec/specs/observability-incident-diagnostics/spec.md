# Observability & Incident Diagnostics Specification

## Purpose

This spec captures the current v0.7 observability and incident diagnostics capability on `main`. It covers platform-admin incident summaries, safe evidence refs, diagnostic retention dry-run/prune behavior, and redaction of raw operational payloads.
## Requirements
