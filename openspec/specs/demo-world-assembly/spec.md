# Demo World Assembly Specification

## Purpose
This spec captures the current v0.9 demo world assembly path on `main`. It covers reviewable assembly from applied source, dialogue, persona, memory, visual, voice, and visual-generation-profile evidence into a minimal playable conversation entry point.
