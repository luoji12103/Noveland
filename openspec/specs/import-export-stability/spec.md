# import-export-stability Specification

## Purpose
This spec captures the current v1.1 import/export stability behavior on `main`. It covers repeatable world package export/import, safe manifests for media, persona, memory, visual and voice mappings, source traceability, provider config metadata without secrets, public sample exclusion for proprietary or user-provided assets, and preview/apply import discipline.
## Requirements
