# Self-use MVP Gate Specification

## Purpose
This spec captures the current v0.9 self-use MVP gate on `main`. It covers platform-admin validation of a 30-minute demo play loop, actionable safe failure evidence, manual resume/checklist confirmation, and the boundary that self-use evidence does not imply beta or public launch readiness.
