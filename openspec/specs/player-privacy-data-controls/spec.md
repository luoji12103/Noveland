# Player Privacy & Data Controls Specification

## Purpose

This spec captures the current v0.8 player privacy and data control workflow on `main`. It covers sanitized player data export, reviewable delete/redaction requests, audit-safe request status, and protection for shared canonical world history.
