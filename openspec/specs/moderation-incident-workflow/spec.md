# Moderation & Incident Workflow Specification

## Purpose

This spec captures the current v0.8 moderation and incident workflow on `main`. It covers reviewable reports, bounded moderation actions, public-surface incident records, safe evidence references, and reader-delivery suppression for applied takedowns.
