...
describe("ConversationPlayback", () => {
  it("renders conversation turns with reader-safe media delivery paths", () => {
  ...
  it("shows a safe empty state", () => {
    render(
      <ConversationPlayback
        ...
        data={{ ...playbackData, conversation: null, turns: [], loadError: "Conversation not found." }}
      />,
    );
