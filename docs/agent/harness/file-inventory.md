...
- `backend/services/api/src/noveland/services/api/worlds.py` — includes role-aware member/admin response shaping for world, agent, schedule-rule, narrative artifact, organization, organization membership, and faction-track DTO boundaries.
