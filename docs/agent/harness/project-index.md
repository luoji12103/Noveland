...
- `openspec/changes/v1-0-private-beta-mvp/` — active OpenSpec roadmap for invite-only private beta: onboarding/access, player session stability, quota enforcement, setup wizard, memory/persona QA, beta feedback, repair loop, and private beta gate.
